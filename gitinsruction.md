...
```
Если была изменнннена одна и та же часть файла в обоих ветках, то может возникнуть конфликт, который потребует участие пользователя. VSC предлогает варианты разрешшшшения, необходимо выбрать вариант, либо объединить содержимое по-своему.