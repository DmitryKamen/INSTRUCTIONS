...
```
Если была изменена одна и та же часть файла в обоих ветках, то может возникнуть конфликт, который потребует участие пользователя. VSC предлогает варианты разрешения, необходимо выбрать вариант, либо объединить содержимое по-своему.
